...
def get_dataset(split_file, images_file):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--images_file", action="store", type=str, required=True)
    parser.add_argument("--metadataset", action="store_true")
    parser.add_argument("-o", "--output_fp", action="store", type=str, default="./data/meta/cub_metadataset.meta.json")
    ...
    split_file, images_file, output_fp = args.split_file, args.images_file, args.output_fp
    ...
    output_fp = generate_meta_file(split_file, images_file, output_fp, way, shot, test_episode, test_query_num, val_episode, val_query_num, is_metadataset)
