...
def get_dataset(split_file, images_dir):
...
def generate_meta_file(split_file, images_file, output_fp, way, shot, test_episode, test_query_num, val_episode, val_query_num, is_metadataset):
    train_dataset, test_dataset = get_dataset(split_file, images_file)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--images_dir", action="store", type=str, default="./data/dtd/dtd_metadataset_split.meta.json")
    parser.add_argument("--metadataset", action="store_true")
    parser.add_argument("-o", "--output_fp", action="store", type=str, default="./data/meta/dtd_metadataset.meta.json")
    ...
    split_file, images_dir, output_fp = args.split_file, args.images_dir, args.output_fp
    ...
    output_fp = generate_meta_file(split_file, images_dir, output_fp, way, shot, test_episode, test_query_num, val_episode, val_query_num, is_metadataset)
